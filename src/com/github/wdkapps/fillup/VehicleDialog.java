	...
	public static Dialog create(
        ...
        buttonOK.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!isValidPlate(brand)) {
                    message = res.getString(R.string.toast_inavlid_vehicle_brand);
                    Utilities.toast(context,message);
                    return;
                }
                ...
                if (!isValidPlate(type)) {
                    message = res.getString(R.string.toast_inavlid_vehicle_type);
                    Utilities.toast(context,message);
                    return;
                }
                ...
                if (!isValidPlate(plate)) {
                    message = res.getString(R.string.toast_inavlid_vehicle_plate);
                    Utilities.toast(context,message);
                    return;
                }
